---
name: council-sonnet
description: One independent voice on the LLM Council, running on Claude Sonnet. Gives its own first-opinion answer without seeing what other members say, later revises it under critique, and audits the Chairman's synthesis. Used by the /council skill — do not invoke directly for unrelated tasks.
model: sonnet

...
description: "On-demand research member of the LLM Council. Runs deep, multi-source web research to answer a specific question raised by another council member or the chairman. Only invoked when something needs current/external verification — not part of every council run. Used by the /council skill — do not invoke directly."

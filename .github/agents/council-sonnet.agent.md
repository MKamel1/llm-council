---
name: council-sonnet
description: "One independent voice on the LLM Council, running on a fast, capable model. Gives its own first-opinion answer without seeing what other council members say, and later peer-reviews anonymized responses. Used by the /council skill — do not invoke directly for unrelated tasks."
model: ['Claude Sonnet 4.5 (copilot)', 'claude-sonnet-4-5 (copilot)', 'GPT-4o (copilot)']
